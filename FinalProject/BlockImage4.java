...
public class BlockImage4 extends Canvas {
         ...
         * @param rs
         */
        public BlockImage4(Image bImage, Image overImage, int cs, int rs) {
        ...
        public BlockImage4(){
            ...
            try {
            	backImage = ImageIO.read(new File("src/resources/img/puzzle-4.jpg"));
            } catch (IOException e) {
            }                
