...
public class BlockImage5 extends Canvas {
         ...
         * @param rs
         */
        public BlockImage5(Image bImage, Image overImage, int cs, int rs) {
        ...
        public BlockImage5(){
            ...
            try {
            	backImage = ImageIO.read(new File("src/resources/img/puzzle-5.jpg"));
            } catch (IOException e) {
            }                
            frm.add(new BlockImage(backImage,overImage, 5, 5));
